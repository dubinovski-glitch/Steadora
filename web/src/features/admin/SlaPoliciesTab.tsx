          ...
          {tiers.map(tier => (
            ...
            >
              <div className="flex items-center justify-between mb-1">
                ...
                <span className={`text-[10px] px-1.5 py-0.5 rounded-full font-medium ${tier.isActive ? 'bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-400' : 'bg-subtle text-text-muted'}`}>
